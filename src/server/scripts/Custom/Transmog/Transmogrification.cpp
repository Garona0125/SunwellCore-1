...
{
    sLog->outStaticDebug( "Transmogrification::PresetTransmog");
...
{
    sLog->outStaticDebug( "Transmogrification::LoadPlayerSets");
...
{
    sLog->outStaticDebug( "Transmogrification::GetSlotName");
...
{
    sLog->outStaticDebug( "Transmogrification::GetItemIcon");
...
{
    sLog->outStaticDebug( "Transmogrification::GetSlotIcon");
...
{
    sLog->outStaticDebug( "Transmogrification::GetItemLink");
...
{
    sLog->outStaticDebug( "Transmogrification::GetFakeEntry");
...
{
    sLog->outStaticDebug( "Transmogrification::UpdateItem");
...
{
    sLog->outStaticDebug( "Transmogrification::DeleteFakeEntry");
...
{
    sLog->outStaticDebug( "Transmogrification::SetFakeEntry");
...
{
    sLog->outStaticDebug( "Transmogrification::Transmogrify");

    // slot of the transmogrified item
    if (slot >= EQUIPMENT_SLOT_END)
    {
        sLog->outStaticDebug( "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) tried to transmogrify an item (lowguid: %u) with a wrong slot (%u) when transmogrifying items.", player->GetGUIDLow(), player->GetName().c_str(), GUID_LOPART(itemGUID), slot);
    ...
    if (itemGUID)
    {
        ...
        {
            sLog->outStaticDebug( "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) tried to transmogrify with an invalid item (lowguid: %u).", player->GetGUIDLow(), player->GetName().c_str(), GUID_LOPART(itemGUID));
    ...
    {
        sLog->outStaticDebug( "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) tried to transmogrify an invalid item in a valid slot (slot: %u).", player->GetGUIDLow(), player->GetName().c_str(), slot);
    ...
    else
    {
        ...
        {
            sLog->outStaticDebug( "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) failed CanTransmogrifyItemWithItem (%u with %u).", player->GetGUIDLow(), player->GetName().c_str(), itemTransmogrified->GetEntry(), itemTransmogrifier->GetEntry());
        ...
        if (!no_cost)
        {
            ...
            {
                if (cost < 0)
                    sLog->outStaticDebug( "Transmogrification::Transmogrify - Player (GUID: %u, name: %s) transmogrification invalid cost (non negative, amount %i). Transmogrified %u with %u", player->GetGUIDLow(), player->GetName().c_str(), -cost, itemTransmogrified->GetEntry(), itemTransmogrifier->GetEntry());
                else
                {
...
{
    sLog->outStaticDebug( "Transmogrification::CanTransmogrifyItemWithItem");
...
{
    sLog->outStaticDebug( "Transmogrification::SuitableForTransmogrification");
...
{
    sLog->outStaticDebug( "Transmogrification::GetSpecialPrice");
...
{
    sLog->outStaticDebug( "Transmogrification::IsRangedWeapon");
...
{
    sLog->outStaticDebug( "Transmogrification::IsAllowed");
...
{
    sLog->outStaticDebug( "Transmogrification::IsNotAllowed");
...
{
    sLog->outStaticDebug( "Transmogrification::IsAllowedQuality");
...
{
    sLog->outStaticDebug( "Transmogrification::LoadConfig");
    ...
    {
		sLog->outString("Transmogrification.TokenEntry (%u) does not exist. Using default (%u).", TokenEntry, 49426);
        TokenEntry = 49426;
    }
}
...
namespace
{
            ...
            if (result)
            {
                do
                {
                    ...
                    else
                    {
                        ...
                        // TC_LOG_ERROR( "Item entry (Entry: %u, itemGUID: %u, playerGUID: %u) does not exist, ignoring.", fakeEntry, GUID_LOPART(itemGUID), player->GetGUIDLow());
    ...
    public:
        ...
        {
			sLog->outChar( "Deleting non-existing transmogrification entries...");
